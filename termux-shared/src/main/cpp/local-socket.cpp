...
jobject getJniResult(JNIEnv *env, jstring title, const int retvalParam, const int errnoParam,
                     string errmsgParam, const int intDataParam) {
    jclass clazz = env->FindClass("com/rustywarfare/modstudio/shared/jni/models/JniResult");
...
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_createServerSocketNative(JNIEnv *env, jclass clazz,
                                                                                    jstring logTitle,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_closeSocketNative(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_acceptNative(JNIEnv *env, jclass clazz,
                                                                        jstring logTitle, jint fd) {
    if (fd < 0) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_readNative(JNIEnv *env, jclass clazz,
                                                                      jstring logTitle,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_sendNative(JNIEnv *env, jclass clazz,
                                                                      jstring logTitle,
                                                                      jint fd, jbyteArray dataArray,
                                                                      jlong deadline) {
    if (fd < 0) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_availableNative(JNIEnv *env, jclass clazz,
                                                                           jstring logTitle, jint fd) {
    if (fd < 0) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_setSocketReadTimeoutNative(JNIEnv *env, jclass clazz,
                                                                                      jstring logTitle,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_setSocketSendTimeoutNative(JNIEnv *env, jclass clazz,
                                                                                      jstring logTitle,
                                                                                      jint fd, jint timeout) {
    if (fd < 0) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_rustywarfare_modstudio_shared_net_socket_local_LocalSocketManager_getPeerCredNative(JNIEnv *env, jclass clazz,
                                                                             jstring logTitle,
    ...
    // Fill "com_rustywarfare_modstudio.shared.net.socket.local.PeerCred" object.
