package com.rustywarfare.modstudio.shared.termux.file;
...
import com.rustywarfare.modstudio.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     * `/system/bin/ls -lhd /data/user/10/com.rustywarfare.modstudio` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.rustywarfare.modstudio` where `10` is
    ...
    public static String getTermuxFilesStatMarkdownString(@NonNull final Context context) {
        ...
        statScript
            ...
            .append(" '" + TermuxConstants.TERMUX_FILES_DIR_PATH + "'").append(" '").append(filesDir).append("'")
