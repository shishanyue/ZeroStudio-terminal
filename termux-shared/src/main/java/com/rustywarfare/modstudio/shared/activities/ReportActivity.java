package com.rustywarfare.modstudio.shared.activities;
 ...
 * {@code `<activity android:name="com.rustywarfare.modstudio.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
