...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.rustywarfare.modstudio.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.rustywarfare.modstudio/10xxx}
             */
