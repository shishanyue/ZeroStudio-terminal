package com.rustywarfare.modstudio.shared.shell.command;
...
public class ExecutionCommand {
    ...
    */
     ...
     * commands. By default, @link com.rustywarfare.modstudio.shared.shell.StreamGobbler} only logs stdout and
