...
JNIEXPORT jint JNICALL Java_com_rustywarfare_modstudio_terminal_JNI_createSubprocess(
        JNIEnv* env,
...
JNIEXPORT void JNICALL Java_com_rustywarfare_modstudio_terminal_JNI_setPtyWindowSize(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint fd, jint rows, jint cols, jint cell_width, jint cell_height)
{
...
JNIEXPORT void JNICALL Java_com_rustywarfare_modstudio_terminal_JNI_setPtyUTF8Mode(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint fd)
{
    struct termios tios;
    tcgetattr(fd, &tios);
...
JNIEXPORT jint JNICALL Java_com_rustywarfare_modstudio_terminal_JNI_waitFor(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint pid)
{
    int status;
...
JNIEXPORT void JNICALL Java_com_rustywarfare_modstudio_terminal_JNI_close(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint fileDescriptor)
{
