...
import com.rustywarfare.modstudio.shared.termux.terminal.io.BellHandler;
import com.rustywarfare.modstudio.shared.logger.Logger;
import com.rustywarfare.modstudio.terminal.TerminalColors;
...
import com.rustywarfare.modstudio.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.rustywarfare.modstudio.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.rustywarfare.modstudio/com.rustywarfare.modstudio.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
