package com.rustywarfare.modstudio.app;
...
import com.rustywarfare.modstudio.app.event.SystemEventReceiver;
import com.rustywarfare.modstudio.app.terminal.TermuxTerminalSessionActivityClient;
import com.rustywarfare.modstudio.app.terminal.TermuxTerminalSessionServiceClient;
import com.rustywarfare.modstudio.shared.termux.plugins.TermuxPluginUtils;
import com.rustywarfare.modstudio.shared.data.IntentUtils;
import com.rustywarfare.modstudio.shared.net.uri.UriUtils;
import com.rustywarfare.modstudio.shared.errors.Errno;
import com.rustywarfare.modstudio.shared.shell.ShellUtils;
import com.rustywarfare.modstudio.shared.shell.command.runner.app.AppShell;
import com.rustywarfare.modstudio.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.rustywarfare.modstudio.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.rustywarfare.modstudio.shared.termux.shell.TermuxShellUtils;
import com.rustywarfare.modstudio.shared.termux.TermuxConstants;
import com.rustywarfare.modstudio.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.rustywarfare.modstudio.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.rustywarfare.modstudio.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.rustywarfare.modstudio.shared.termux.shell.TermuxShellManager;
...
import com.rustywarfare.modstudio.shared.notification.NotificationUtils;
import com.rustywarfare.modstudio.shared.android.PermissionUtils;
import com.rustywarfare.modstudio.shared.data.DataUtils;
...
import com.rustywarfare.modstudio.shared.shell.command.ExecutionCommand.ShellCreateMode;
