package com.rustywarfare.modstudio.app.terminal.io;
...
import com.rustywarfare.modstudio.shared.termux.settings.properties.TermuxSharedProperties;
...
public class TermuxTerminalExtraKeys extends TerminalExtraKeys {
    ...
    public void onTerminalExtraKeyButtonClick(View view, String key, boolean ctrlDown, boolean altDown, boolean shiftDown, boolean fnDown) {
        switch (key) {
            ...
            case null, default -> super.onTerminalExtraKeyButtonClick(view, key, ctrlDown, altDown, shiftDown, fnDown);
        }
    }
